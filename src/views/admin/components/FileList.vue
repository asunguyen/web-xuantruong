<template>
  <el-dialog title="File List" :visible.sync="isShow" width="80%" :before-close="closeModal">
    <div class="row">
        ...
        <div class="row p-4 align-items-center h-100">
          ...
          <form class="form-horizontal" method="POST" enctype="multipart/form-data" id="fileUploadForm">
            <div class="form-group">
              ...
              <button type="btn" id="btn-upload" name="upload" @click="handleUploadFile"
      ...
      <div class="col-8">
        <div class="row">
          ...
          <div class="col-8">
            <el-input placeholder="Input name image" v-model="searchName" @change="handleSearch"></el-input>
          </div>
          <div class="col-2">
            <el-button class="w-100" @click="handleSearch" type="success" plain>Search</el-button>
          </div>
        </div>
        <hr />
        <el-table ref="table" :data="tableData" style="width: 100%" :highlight-current-row="!isMultiSelect"
          @current-change="selectedRow" @selection-change="selectedRow">
        ...
        <el-pagination class="pt-3" @size-change="handleSizeChange" @current-change="handleCurrentChange"
          :current-page.sync="pagination.currentPage" :page-sizes="[1, 5, 10, 20, 50]" :page-size="pagination.pageSize"
          layout="total, sizes, prev, pager, next, jumper" :total="pagination.totalItems">
        </el-pagination>
      </div>
    </div>
    <span slot="footer" class="dialog-footer">
      <el-button @click="closeModal">Cancel</el-button>
      <el-button :disabled="!selected" type="primary" @click="handleSelected">Select</el-button>
    </span>
  </el-dialog>
</template>
